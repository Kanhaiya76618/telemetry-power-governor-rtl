...
static void bridge_send_frame(BridgeCtx *ctx)
{
    ...
    u8 temp_a = (u8)((echo >> 0) & 0x7FU);
    u8 temp_b = (u8)((echo >> 8) & 0x7FU);
    u8 act_a = (u8)((echo >> 15) & 0x1U);
    u8 stall_a = (u8)((echo >> 16) & 0x1U);
    u8 act_b = (u8)((echo >> 17) & 0x1U);
    u8 stall_b = (u8)((echo >> 18) & 0x1U);
    u8 req_a = (u8)((echo >> 19) & 0x3U);
    u8 req_b = (u8)((echo >> 21) & 0x3U);
